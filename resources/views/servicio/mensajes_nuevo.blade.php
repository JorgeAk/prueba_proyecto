...
<div class="right_col" role="main">
    <div>
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i> Servicio/<STRONG>Mensajes/nuevo</STRONG>
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="container bootdey">
                <div class="email-app">
                    ...
                    <main>
                        ...
                        <form class="" method="POST" enctype="multipart/form-data" action="{{ route('/servicio/correo/mensajes/nuevo/enviar') }}">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-sm-11 ml-auto">
                                    ...
                                    <div class="form-group centrar">
                                        ...
                                        <a href="{{ route('/servicio/correo/mensajes') }}" class="btn btn-danger">Descartar</a>
                                    </div>
                        </form>
                </div>
            </div>
