  ...
  <div class="right_col" role="main">
    <div>
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          <li class="active">
            <i class="fa fa-dashboard"></i> Servicio/Oficios<STRONG>/Modificar</STRONG>
          </li>
        </ol>
      </div>
    </div>
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="x_content">
                    <br>
                    <form id="demo-form2"  method="POST" action="{{ route('/servicio/oficios/agregar/nuevo') }}" class="form-horizontal form-label-left" >
                      @csrf
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Agregar campo<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                           <a href="javascript:void(0);" class="add_button btn btn-success" title="Add field"><i class="fa fa-plus-circle"></i></a>
                        </div>
                      </div>
