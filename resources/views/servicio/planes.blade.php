...
<div class="right_col" role="main">
  <div>
    <div class="col-lg-12">
      ...
      <ol class="breadcrumb">
        <li class="active">
          <i class="fa fa-dashboard"></i> Servicio/planes<STRONG>/Agregar</STRONG>
        </li>
      </ol>
    </div>
  </div>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form id="demo-form2" method="POST" action="{{ route('/servicio/planes/modificar/actualizar') }}" class="form-horizontal form-label-left">
                        @csrf
