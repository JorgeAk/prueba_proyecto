...
<div class="right_col" role="main">
    <div>
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i> Servicio/Alumno/<STRONG>Solicitud</STRONG>
                </li>
            </ol>
        </div>
    </div>
                    ...
                    <div class="col-md-12 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <br>
                                <form class="" method="POST" enctype="multipart/form-data" action="{{ route('/servicio/alumnos/solicitudes/actualizar') }}">
                                    @csrf
