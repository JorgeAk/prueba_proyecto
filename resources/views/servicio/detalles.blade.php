                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="home" role="tabpanel"
                                            ...
                                            <form class="" method="POST" enctype="multipart/form-data"
                                                action="{{ route('/servicio/alumnos/solicitudes/actualizar') }}">
                                                @csrf
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        @if (count($oficios) > 0)
                                                            ...
                                                            <div id="accordion{{ $alum->id }}">
                                                                <div class="card">
                                                                    <div class="card-header centrar" id="headingOne">
                                                                        ...
                                                                        <h5 class="mb-0 ">
                                                                            ...
                                                                            <a onclick="muestra('muestra{{ $alum->id }}','oculta{{ $alum->id }}')"
                                                                                id="muestra{{ $alum->id }}"
                                                                                data-toggle="collapse"
                                                                                data-target="#collapseOne{{ $alum->id }}"
                                                                                aria-expanded="true"
                                                                                class="btn btn-app img-close ">
                                                                                <span
                                                                                    class="badge bg-orange">{{ $contador_of }}</span>
                                                                                <i class="fa fa-folder"></i>Oficios Adjuntos
                                                                            </a>

                                                                            <a onclick="oculta('muestra{{ $alum->id }}','oculta{{ $alum->id }}')"
                                                                                id="oculta{{ $alum->id }}"
                                                                                style="display: none" data-toggle="collapse"
                                                                                data-target="#collapseTwo{{ $alum->id }}"
                                                                                aria-expanded="false"
                                                                                aria-controls="collapseTwo{{ $alum->id }}"
                                                                                class="btn btn-app img-open ">
                                                                                <span
                                                                                    class="badge bg-orange">{{ $contador_of }}</span>
                                                                    ...
                                                                    <div id="collapseOne{{ $alum->id }}"
                                                                        class="collapse " aria-labelledby="headingOne"
                                                                        data-parent="#accordion{{ $alum->id }}">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="x_content">
                                                                                ...
                                                                                @foreach ($oficios as $ofi)
                                                                                    @if ($ofi->id_solicitud == $alum->id)
                                                                                        ...
                                                                                        <a class="btn btn-app"
                                                                                            href="{{ route('descargar_archivo', $ofi->url) }}" download="{{$of_name}}_{{ $alum->n_control }}.pdf"
                                                                                            data-toggle="tooltip"
                                                                                            data-placement="top"
                                                                                            title="@foreach ($tipo_oficio as $t_of) 
                                                                                            @if ($t_of->id==$ofi->id_tipo_oficio)
                                                                                            {{ $t_of->nombre }} @endif
                                                                                            @endforeach"><i
                                                                                                    class="fa fa-file-pdf-o"></i></a>
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-header"
                                                                        id="headingTwo{{ $alum->id }}">
                                                                        <h5 class="mb-0">

                                                                        </h5>
                                                                    </div>
                                                                    <div id="collapseTwo{{ $alum->id }}"
                                                                        class="collapse"
                                                                        aria-labelledby="headingTwo{{ $alum->id }}"
                                                                        data-parent="#accordion{{ $alum->id }}">
                                                        ...
                                                        @if ($alum->s_estatus == 2 and $alum->id_optitulacion != 4)
                                                            ...
                                                            <div id="content">
                                                                ...
                                                                <div class=" form-label-group" hidden>
                                                                    ...
                                                                    <input id="inputAp"
                                                                        name="oficio_autorizacion_op_titulacion" type="text"
                                                                        ...
                                                                        <span class="input-group-btn">
                                                                            <div
                                                                                ...
                                                                                <input type="file" accept="application/pdf"
                                                                                    name="oficio_autorizacion_op_titulacion" />
                                                                            </div>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        @if ($alum->s_estatus == 3 and $alum->id_optitulacion != 4)
                                                            ...
                                                            <div id="content">
                                                                ...
                                                                <div class=" form-label-group" hidden>
                                                                    <label for="inputAp">URL del oficio</label>
                                                                    <input id="inputAp" name="oficio_registro_proyecto"
                                                        ...
                                                        @if ($alum->s_estatus == 11 and $alum->id_optitulacion != 4)
                                                            ...
                                                            <div id="content">
                                                                ...
                                                                <div class=" form-label-group" hidden>
                                                                    <label for="inputAp">URL del oficio</label>
                                                                    <input id="inputAp" name="oficio_autorizacion_proyecto"
                                                                        type="text" class="form-control" placeholder="" />
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-group image-preview">
                                                                        <span class="input-group-btn">
                                                                            <div
                                                                                ...
                                                                                <span
                                                                                    ...
                                                                                    archivo</span>
                                                                                <input type="file" accept="application/pdf"
                                                                                    name="oficio_autorizacion_proyecto" />
                                                                            </div>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        @if ($alum->s_estatus == 6)
                                                            ...
                                                            <div id="content">
                                                                ...
                                                                <div class=" form-label-group" hidden>
                                                                    <label for="inputAp">URL del oficio</label>
                                                                    <input id="inputAp" name="oficio_asigacion_revisores"
                                                                        type="text" class="form-control" placeholder="" />
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-group image-preview">
                                                                        <span class="input-group-btn">
                                                                            <div
                                                                                ...
                                                                                <span
                                                                                    ...
                                                                                    archivo</span>
                                                                                <input type="file" accept="application/pdf"
                                                                                    name="oficio_asigacion_revisores" />
                                                                            </div>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            @endforeach
                                                                ...
                                                                <div id="content">
                                                                    ...
                                                                    <div class=" form-label-group" hidden>
                                                                        <label for="inputAp">URL del oficio</label>
                                                                        @if ($alum->id_optitulacion == 4)
                                                                            <input id="inputAp" name="oficio_sol_sinodales"
                                                                                type="text" class="form-control"
                                                                                placeholder="" />
                                                                        @endif
                                                                        @if ($alum->id_optitulacion != 4)
                                                                            <input id="inputAp" name="oficio_sol_sinodales2"
                                                                                type="text" class="form-control"
                                                                                placeholder="" />
                                                                        @endif
                                                                    </div>
                                                        ...
                                                        @if ($alum->s_estatus == 15)
                                                            ...
                                                            <div id="content">
                                                                ...
                                                                <div class=" form-label-group" hidden>
                                                                    <label for="inputAp">URL del oficio</label>
                                                                    <input id="inputAp" name="oficio_impresion_definitiva"
                                                                        type="text" class="form-control" placeholder="" />
                                                                </div>
                                                                <div class="form-group" >
                                                                    <div class="input-group image-preview">
                                                                        <span class="input-group-btn">
                                                                            <div
                                                                                ...
                                                                                <span
                                                                                    ...
                                                                                    archivo</span>
                                                                                <input type="file" accept="application/pdf"
                                                                                    name="oficio_impresion_definitiva" />
                                                                            </div>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <span class="input-group-btn">
                                                                            <div
                                                                                ...
                                                                                <span
                                                                                    ...
                                                                                    archivo</span>
                                                                                <input type="file" accept="application/pdf"
                                                                                    name="oficio_liberacion_proyecto" />
                                                                            </div>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <input hidden type="text" id="last-name"
                                                                        name="oficio_ceremonia" value="si"
                                                                        class="form-control">
                                                                    <input hidden type="text" id="last-name"
