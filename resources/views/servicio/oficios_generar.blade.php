...
<div class="right_col" role="main">
    <div>
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i> Servicios/Oficios<STRONG>/Agregar</STRONG>
                </li>
            </ol>
        </div>
    </div>
    <div class="card">
        <div class="card-header">
            ...
            <div class="x_content">
                <br>
                <form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="{{ route('/servicio/oficios/imprimir') }}">
                    @csrf
