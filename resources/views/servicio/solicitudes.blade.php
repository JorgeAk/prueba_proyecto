      ...
      <div class="right_col" role="main">
          <div>
              <div class="col-lg-12">
                  ...
                  <ol class="breadcrumb">
                      <li class="active">
                          <i class="fa fa-dashboard"></i> Servicio/Alumnos/<STRONG>Solicitudes</STRONG>
                      </li>
                  </ol>
              </div>
          </div>
                                      ...
                                      <tbody>
                                          ...
                                          <tr class="centrar">
                                              ...
                                              <td style="white-space:nowrap !important;">
                                                  ...
                                                  <a href="{{ route('/servicio/solicitudDetalle', $alum->id) }}" class="btn btn-lg btn-success btn-sm" title="Dar seguimiento a solicitud" style="display: inline-block !important;"><i class="fa fa-exclamation" aria-hidden="true"></i></a>
                                                  @endif
                                                  @if ($alum->s_estatus == 14)
                                                  <a href="{{ route('/servicio/solicitudDetalle', $alum->id) }}" class="btn btn-lg btn-success btn-sm" title="Generar Oficio liberacion de proyecto" style="display: inline-block !important;"><i class="fa fa-exclamation" aria-hidden="true"></i></a>
                                                  @endif
                                                  @if ($alum->s_estatus == 15)
                                                  <a href="{{ route('/servicio/solicitudDetalle', $alum->id) }}" class="btn btn-lg btn-success btn-sm" title="Generar Oficio impresion definitiva" style="display: inline-block !important;"><i class="fa fa-exclamation" aria-hidden="true"></i></a>
                                                  @endif
                                                  @if ($alum->s_estatus == 3 or $alum->s_estatus == 6)
                                                  <a href="{{ route('/servicio/solicitudDetalle', $alum->id) }}" class="btn btn-lg btn-success btn-sm" title="Asignar revisores" style="display: inline-block !important;"><i class="fa fa-check-square-o " aria-hidden="true"></i></a>
                                                  @endif
                                                  @if ($alum->s_estatus == 5)
                                                  <a href="{{ route('/servicio/solicitudDetalle', $alum->id) }}" class="btn btn-lg btn-success btn-sm" title="Asignacion de Sinodales" style="display: inline-block !important;"><i class="fa fa-check-square-o  " aria-hidden="true"></i></a>
                                                  @endif
                                              </td>
                                          </tr>
                                          @else
                                                                  ...
                                                                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                                      <div class="row ">
                                                                          ...
                                                                          <div class="col-md-6">
                                                                              ...
                                                                              <a href="{{ route('/servicio/solicitudDetalle', $alum->id) }}"><button class="btn btn-success pull-right form-control" style="margin-right: 5px;"><i class="fa fa-pencil-square-o" aria-hidden="true"> </i>
                                                                                      &nbsp;Modificar </button>
                                                                              </a>
                                                                          </div>
                                                                      </div>
