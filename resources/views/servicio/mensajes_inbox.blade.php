            ...
            <div class="card-body">
                <div class="container bootdey">
                    <div class="email-app mb-4">
                        <nav>
                            <a href="{{ route('/servicio/correo/mensajes/nuevo/crear') }}"
                                class="btn btn-success btn-block">Correo nuevo</a>
                            <ul class="nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('/servicio/correo/mensajes', 'inbox') }}"><i
                                            class="fa fa-inbox"></i>Bandeja<span
                                            class="badge badge-danger">{{ count($m_nuevos) }}</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('/servicio/correo/mensajes', 'enviados') }}"><i
                                            class="fa fa-rocket"></i> Enviados</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('/servicio/correo/mensajes', 'importantes') }}"><i
                            ...
                            <div class="toolbar">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-light">
                                        <a href="{{ route('/servicio/correo/mensajes/nuevo/crear') }}"> <span
                                    ...
                                    <button type="button" class="btn btn-light">
                                        <a href="{{ route('/servicio/correo/mensajes', 'importantes') }}"> <span
