...
<div class="right_col" role="main">
  <div>
    <div class="col-lg-12">
      ...
      <ol class="breadcrumb">
        <li class="active">
          <i class="fa fa-dashboard"></i> Servicio/Profesores/<STRONG>Sinodales</STRONG>
        </li>
      </ol>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-header"><h4>Lista de profesores asignados como sinodales</h4></div>
