        ...
        <div class="email-app mb-4">
          ...
          <main class="inbox">
            <div class="toolbar">
              <div class="btn-group">
                <button type="button" class="btn btn-light">
                  <a href="{{ route('coordinacion/titulaciones/correo/mensajes/nuevo/crear') }}"> <span class="fa fa-envelope"></span> </a>
                </button>
                <button type="button" class="btn btn-light">
                ...
                <button type="button" class="btn btn-light">
                  <a href="{{ route('coordinacion/titulaciones/correo/mensajes','importantes') }}"> <span class="fa fa-bookmark-o"></span> </a>
                </button>
              </div>
            ...
            <ul class="messages">
              ...
              <li class="message">
                <a href="{{ route('coordinacion/titulaciones/mensajeSe_Detalle_r2', $rec->id) }}">
                  <div class="actions">
