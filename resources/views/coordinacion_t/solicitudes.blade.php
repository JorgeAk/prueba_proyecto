...
<div class="right_col" role="main">
    <div>
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i> Coordinacion de titulaciones/Alumnos/<STRONG>Solicitudes</STRONG>
                </li>
            </ol>
        </div>
    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="centrar">
                                        ...
                                        <td style="white-space:nowrap !important;">
                                            ...
                                            @if ($alum->s_estatus == 4)
                                            <a href="{{ route('detalleCT', $alum->id) }}" class="btn btn-lg btn-success btn-sm" title="Validar documentos" style="display: inline-block !important;"><i class="fa fa-pencil-square-o " aria-hidden="true"></i></a>
                                            @endif
                                            @if ($alum->s_estatus == 2)
                                            <a href="{{ route('detalleCT', $alum->id) }}" class="btn btn-lg btn-success btn-sm" title="Dar seguimiento a solicitud" style="display: inline-block !important;"><i class="fa fa-exclamation" aria-hidden="true"></i></a>
                                            @endif
                                            @if ($alum->s_estatus == 8)
                                            <a href="{{ route('detalleCT', $alum->id) }}" class="btn btn-lg btn-success btn-sm" title="Generar Ceremonia de titulacion" style="display: inline-block !important;"><i class="fa fa-graduation-cap " aria-hidden="true"></i></a>
                                            @endif
                                        </td>
                                    </tr>
                                    @else
                                    @if ($alum->s_estatus== 4 or $alum->s_estatus== 8 or $alum->s_estatus== 9 or $alum->s_estatus== 18 )
                                    <tr class="centrar">
                                        <td>{{ $alum->n_control }}</td>
                                        <td>{{ $alum->p_nombre }} {{ $alum->s_nombre }}</td>
                                        <td>{{ $alum->a_paterno }}</td>
                                                                ...
                                                                <div class="row ">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class=" form-label-group">
                                                                            ...
                                                                            <input readonly id="inputCarrera" name="f_egreso" type="text" class="form-control" placeholder="{{ $alum->repositorio_documentos }}" required value="{{ $alum->repositorio_documentos }}" />
                                                                        </div>
                                                                        ...
                                                                        @if ($alum->id_optitulacion != 4 )
                                                                        @else
                                                                        @if ($alum->s_estatus == 8 or $alum->s_estatus == 9 )
                                                                        <br>
