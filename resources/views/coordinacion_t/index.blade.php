...
<div class="right_col" role="main">
    <div>
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i> Coordinacion de titulaciones/<STRONG>Home</STRONG>
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="animated flipInY col-lg-2 col-md-3 col-sm-6">
                    ...
                    <div class="color1 est ">
                        <h5 class="centrar ">
                            <small>
                                <a href="{{ route('/coordinacion/titulaciones/alumnos/solicitudes') }}">Ver <i class="fa fa-arrow-circle-right"></i></a>
                            </small>
                        </h5>
                    </div>
                </div>
                ...
                <div class="animated flipInY col-lg-2 col-md-3 col-sm-6  ">
                    ...
                    <div class="color1 est" style="">
                        <h5 class="centrar"><small><a href="{{ route('/coordinacion/titulaciones/alumnos/solicitudes') }}">Ver <i class="fa fa-arrow-circle-right"></i></a> </small></h5>
                    </div>
                </div>
                <div class="animated flipInY col-lg-2 col-md-3 col-sm-6   ">
                    <div class="tile-stats ">
