    ...
    <div class="right_col" role="main">
        <div>
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li class="active">
                        <i class="fa fa-dashboard"></i> Docencia/<STRONG>Home</STRONG>
                    </li>
                </ol>
            </div>
        </div>
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="animated flipInY col-lg-2 col-md-3 col-sm-6"></div>
                    <div class="animated flipInY col-lg-2 col-md-3 col-sm-6">
                        <div class="tile-stats">
                            ...
                            @if (!empty($resumen))
                                @if ($resumen['solicitudes'] > 0)
                                    <div class="count counter" data-target="{{ $resumen['solicitudes'] }}">
                                        {{ $resumen['solicitudes'] }}</div>
                                @else
                        ...
                        <div class="color1 est ">
                            <h5 class="centrar ">
                                <small>
                                    <a href="{{ route('/coordinacion/titulaciones/alumnos/solicitudes') }}">Ver <i
                        ...
                        <div class="tile-stats ">
                            ...
                            @if (!empty($resumen))
                                @if ($resumen['aceptados'] > 0)
                                    <div class="count counter" data-target="{{ $resumen['aceptados'] }}">
                                        {{ $resumen['aceptados'] }}</div>
                                @else
                                    <div class="count counter" data-target="0">0</div>
                                @endif
                            @endif
                    ...
                    <div class="animated flipInY col-lg-2 col-md-3 col-sm-6  ">
                        <div class="tile-stats ">
                            ...
                            @if (!empty($resumen))
                                @if ($resumen['revision'] > 0)
                                    <div class="count counter" data-target="{{ $resumen['revision'] }}">
                                        {{ $resumen['revision'] }}</div>
                                @else
                                    <div class="count counter" data-target="0">0</div>
                                @endif
                            @endif
                        ...
                        <div class="color1 est" style="">
                            <h5 class="centrar"><small><a
                                        href="{{ route('/coordinacion/titulaciones/alumnos/solicitudes') }}">Ver <i
                                            class="fa fa-arrow-circle-right"></i></a> </small></h5>
                        </div>
                    </div>
                    <div class="animated flipInY col-lg-2 col-md-3 col-sm-6   ">
                        <div class="tile-stats ">
                            ...
                            @if (!empty($resumen))
                                @if ($resumen['rechazado'] > 0)
                                    <div class="count counter" data-target="{{ $resumen['rechazado'] }}">
                                        {{ $resumen['rechazado'] }}</div>
                                @else
                                    <div class="count counter" data-target="0">0</div>
                                @endif
                            @endif
