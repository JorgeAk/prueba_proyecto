...
<div class="right_col" role="main">
    <div>
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i> Coordinacion de titulaciones/Oficios<STRONG>/Agregar</STRONG>
                </li>
            </ol>
        </div>
    </div>
    <div class="card">
        <div class="card-header">
            ...
            <div class="x_content">
                <br>
                <form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="{{ route('/coordinacion/oficios/imprimir') }}">
                    @csrf
                    <div class="form-group row">
                        <label class="control-label col-md-3 col-sm-3 ">Oficio</label>
                        <div class="col-md-9 col-sm-9 ">
                            <select id="status" class="form-control" name="tipo_oficio" onChange="mostrar_oficio(this.value);" required>
                    ...
                    <!---------------------- Oficio 1 ------------------------------------------------->
                    <!---------------------- Oficio 3 ------------------------------------------------->
                    <div id="of3" style="display: none;">
                        <div class="form-group row">
                            <label class="control-label col-md-3 col-sm-3 ">Sala</label>
                            <div class="col-md-9 col-sm-9 ">
                                <select id="status" class="form-control" name="sala">
