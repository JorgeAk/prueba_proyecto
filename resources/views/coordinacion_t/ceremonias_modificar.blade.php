...
<div class="right_col" role="main">
  <div>
    <div class="col-lg-12">
      ...
      <ol class="breadcrumb">
        <li class="active">
          <i class="fa fa-dashboard"></i> Coordinacion de titulaciones/Ceremonias/<STRONG>Modificar</STRONG>
        </li>
      </ol>
    </div>
  </div>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form id="demo-form2" method="POST" action="{{ route('/coordinacion/titulaciones/documentos/modificar/actualizar') }}" class="form-horizontal form-label-left">
                        @csrf
                        <input hidden type="text" id="first-name" name="id_documento" value="{{$doc->id}}" class="form-control ">
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="first-name" name="caracteristicas" placeholder="{{$doc->caracteristicas}}" class="form-control ">
                          </div>
                        </div>
