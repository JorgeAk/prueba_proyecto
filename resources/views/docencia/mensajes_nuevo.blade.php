            ...
            <div class="container bootdey">
                <div class="email-app">
                    ...
                    <main>
                        ...
                        <form class="" method="POST" enctype="multipart/form-data" action="{{ route('docencia/correo/mensajes/nuevo/enviar') }}">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-sm-11 ml-auto">
                                    ...
                                    <div class="form-group centrar">
                                        ...
                                        <a href="{{ route('docencia/correo/mensajes') }}" class="btn btn-danger">Descartar</a>
                                    </div>
                        </form>
                </div>
            </div>
