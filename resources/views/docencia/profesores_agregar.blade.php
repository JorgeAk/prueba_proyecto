  ...
  <div class="right_col" role="main">
    <div>
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          <li class="active">
            <i class="fa fa-dashboard"></i> Docencia/Profesores<STRONG>/Agregar</STRONG>
          </li>
        </ol>
      </div>
    </div>
    <div class="card">
      ...
      <div class="card-body">
        <div class="x_content">
                    <br>
                    <form id="demo-form2" method="POST" action="{{ route('/docencia/profesores/agregar/nuevo') }}"  class="form-horizontal form-label-left" > 
                      @csrf
