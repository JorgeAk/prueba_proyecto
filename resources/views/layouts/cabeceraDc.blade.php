            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="{{ route('/docencia') }}" class="site_title"><i class="fa fa-graduation-cap"></i>
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-home"></i> Inicio <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a href="{{ route('docencia/correo/mensajes', 'inbox') }}">Mensajes</a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-graduation-cap"></i>Alumnos <span
                                    ...
                                    <ul class="nav child_menu">
                                        <li><a href="{{ route('/docencia/alumnos/solicitudes') }}">Solicitudes</a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-black-tie"></i>Ceremonia <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ route('docencia/ceremonias') }}">Ver</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-book"></i>Profesores <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a href="{{ route('/docencia/profesores/modificar') }}">Modificar</a>
                                        </li>
                                        <li><a
                                                href="{{ route('/docencia/profesores/solicitudes/revisores') }}">Revisores</a>
                                        </li>
                                        <li><a
                                                href="{{ route('/docencia/profesores/solicitudes/sinodales') }}">Sinodales</a>
                                        </li>
                                ...
                                <li><a><i class="fa fa-black-tie"></i>Carreras <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                ...
                                <li><a><i class="fa fa-envelope"></i>Correo <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ route('docencia/correo/mensajes', 'inbox') }}">Bandeja</a>
                                        </li>
                                ...
                                <li><a><i class="fa fa-file-text-o"></i>Oficios <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ route('/docencia/oficios/agregar') }}">Agregar</a></li>
                                        <li><a href="{{ route('/docencia/oficios/modificar') }}">Modificar</a></li>
                                        <li><a href="{{ route('/docencia/oficios/generar') }}">Generar</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-users"></i>Control usuarios <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ route('/docencia/control/usuarios') }}">Agregar</a></li>
                                        <li><a
                                                href="{{ route('/docencia/control/usuarios/modificar') }}">Modificar</a>
                                        </li>
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                ...
                                <div class="dropdown-menu dropdown-usermenu pull-right"
                                    ...
                                    <a class="dropdown-item" href="{{ route('/docencia/perfil') }}"><i
                                ...
                                <ul class="dropdown-menu list-unstyled msg_list"
                                    ...
                                    @foreach ($recibidos_ind as $rec)
                                        <li class="nav-item">
                                            <a class="dropdown-item"
                                                href="{{ route('docencia/mensajeSe_Detalle', $rec->id) }}">
                                    ...
                                    <li class="nav-item">
                                        <div class="text-center ">
                                            <a class="dropdown-item"
                                                href="{{ route('docencia/correo/mensajes', 'inbox') }}">
    ...
    <script type="text/javascript">
        ...
        function generar_formulario(id) {
          ...
          var campos = "";
            ...
            $.ajax({
                url: '{{ route('/docencia/oficios/obtener/formulario', '') }}' + '/' + id,
                type: 'get',
                dataType: 'json',
                success: function(response) {
                  var dato = response;
