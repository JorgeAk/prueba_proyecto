...
<head>
 ...
 <link rel=“stylesheet” href=“https://cdn.jsdelivr.net/npm/fontisto@v3.0.4/css/fontisto/fontisto.min.css”></i>
  ...
  <!-- bootstrap-wysiwyg -->
	...
	<link href="{{asset('/res/vendors/google-code-prettify/bin/prettify.min.css') }}" rel="stylesheet">
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="{{ route('/coordinacion/servicios_es') }}" class="site_title"><i class="fa fa-graduation-cap"></i> <span>IT Morelia</span></a>
          </div>
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i> Inicio <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('/coordinacion/servicios_es/perfil') }}">Perfil</a></li>
                    <li><a href="{{ route('/coordinacion/servicios_es/correo/mensajes','inbox') }}">Mensajes</a></li>
                  </ul>
                </li>
                <li><a><i class="fa fa-graduation-cap"></i>Alumnos <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('/coordinacion/servicios_es/alumnos/solicitudes') }}">Solicitudes</a></li>
                  </ul>
                </li>
                ...
                <li><a><i class="fa fa-envelope"></i>Correo <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('/coordinacion/servicios_es/correo/mensajes','inbox') }}">Bandeja</a></li>
          ...
          <ul class=" navbar-right">
            <li class="nav-item dropdown open" style="padding-left: 15px;">
              ...
              <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item"  href="{{ route('/coordinacion/servicios_es/perfil') }}"><i class="fa fa-user"></i>  Perfil</a>
          ...
          <li role="presentation" class="nav-item dropdown open">
           ...
           <!-------------------------------- Muestra mensajes ---------------------------->
            ...
            <ul class="dropdown-menu list-unstyled msg_list " style="height:150px; overflow:hidden; overflow-y:scroll;"  role="menu" aria-labelledby="navbarDropdown1">
              ...
              <li class="nav-item" >
                <a class="dropdown-item" href="{{ route('/coordinacion/servicios_es/mensajeSe_Detalle', $rec->id) }}">
              ...
              <li class="nav-item">
                <div class="text-center ">
                  <a class="dropdown-item" href="{{ route('/coordinacion/servicios_es/correo/mensajes','inbox') }}">
