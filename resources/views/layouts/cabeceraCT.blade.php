...
<head>
 ...
 <link rel=“stylesheet” href=“https://cdn.jsdelivr.net/npm/fontisto@v3.0.4/css/fontisto/fontisto.min.css”></i>
  ...
  <link href="{{asset('/res/vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css')}}" rel="stylesheet">
  
  <!-- Bootstrap Colorpicker -->
  <link href="{{asset('/res/vendors/mjolnic-bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css')}}" rel="stylesheet">
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="{{ route('/coordinacion/titulaciones') }}" class="site_title"><i class="fa fa-graduation-cap"></i> <span>IT Morelia</span></a>
          </div>
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i> Inicio <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('/coordinacion/titulaciones/perfil') }}">Perfil</a></li>
                    <li><a href="{{ route('coordinacion/titulaciones/correo/mensajes','inbox') }}">Mensajes</a></li>
                  </ul>
                </li>
                <li><a><i class="fa fa-graduation-cap"></i>Alumnos <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('/coordinacion/titulaciones/alumnos/solicitudes') }}">Solicitudes</a></li>
                  </ul>
                </li>
                <li><a><i class="fa fa-file"></i>Documentos <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('/coordinacion/titulaciones/documentos/agregar') }}">Agregar</a></li>
                    <li><a href="{{ route('/coordinacion/titulaciones/documentos/modificar') }}">Modificar</a></li>
                ...
                <li><a><i class="fa fa-black-tie"></i>Ceremonia <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('ceremonia_agregar') }}">Ver</a></li>
                  </ul>
                </li>

                <li><a><i class="fa fa-edit"></i>Salas <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('/coordinacion/titulaciones/salas/agregar') }}">Agregar</a></li>
                    <li><a href="{{ route('/coordinacion/titulaciones/salas/modificar') }}">Modificar</a></li>
                ...
                <li><a><i class="fa fa-envelope"></i>Correo <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('coordinacion/titulaciones/correo/mensajes','inbox') }}">Bandeja</a></li>
                    
                  </ul>
                </li>
                <li><a><i class="fa fa-file-text-o"></i>Oficios <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('/coordinacion/titulaciones/oficios/agregar') }}">Agregar</a></li>
                    <li><a href="{{ route('/coordinacion/titulaciones/oficios/modificar') }}">Modificar</a></li>
                    <li><a href="{{ route('/coordinacion/titulaciones/oficios/generar') }}">Generar</a></li>
                  </ul>
                </li>
        ...
        <nav class="nav navbar-nav">
          <ul class=" navbar-right">
            <li class="nav-item dropdown open" style="padding-left: 15px;">
              ...
              <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item"  href="{{ route('/coordinacion/titulaciones/perfil') }}"><i class="fa fa-user"></i>  Perfil</a>
          ...
          <li role="presentation" class="nav-item dropdown open">
            <a href="javascript:;" class="dropdown-toggle info-number" id="navbarDropdown1" data-toggle="dropdown" aria-expanded="false">
              ...
              <span class=""><span class="badge bg-red">{{ count($recibidos_ind)}}</span></span>
            </a>
            ...
            <ul class="dropdown-menu list-unstyled msg_list" style="height:150px; overflow:hidden; overflow-y:scroll;" role="menu" aria-labelledby="navbarDropdown1">
              ...
              <li class="nav-item" >
                <a class="dropdown-item" href="{{ route('coordinacion/titulaciones/mensajeSe_Detalle', $rec->id) }}">
              ...
              <li class="nav-item">
                <div class="text-center ">
                  <a class="dropdown-item" href="{{ route('coordinacion/titulaciones/correo/mensajes','inbox') }}">
...
$(document).ready(function() {
  ...
  <script type="text/javascript">
    function mostrar_oficio(id) {
      ...
      /*
      var vacio ="";
      var n_oficio = '<div class="form-group row" id="id_num_of"><label class="control-label col-md-3 col-sm-3 " for="first-name">Numero de oficio:<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input type="text" required id="first-name" name="num_oficio" class="form-control "></div></div>';
      var dirigido = '<div class="form-group row" id="id_dirigido"><label class="control-label col-md-3 col-sm-3 " for="first-name">Dirigido a:<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="dirigido" class="form-control "></div></div>';
      var puesto   = '<div class="form-group row" id="id_puesto"><label class="control-label col-md-3 col-sm-3 " for="first-name">Puesto<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="puesto" class="form-control"></div></div>';
      var jef_dep  = '<div class="form-group row" id="id_jef_dep"><label class="control-label col-md-3 col-sm-3 " for="first-name">Coordinador (a) de apoyo a la titulacion:<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="genero" class="form-control "></div></div>';
      var depto    = '<div class="form-group row" id="id_jef_dep_depp"><label class="control-label col-md-3 col-sm-3 " for="first-name">Departamento<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="departamento" class="form-control "></div></div>';
      var pres_ac  = '<div class="form-group row" id="id_pres_aca"><label class="control-label col-md-3 col-sm-3 " for="first-name">Presidente de la Academia<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="n_presid_academia" class="form-control "></div></div><div class="form-group row" id="id_pres_aca_area"><label class="control-label col-md-3 col-sm-3 " for="first-name">Area<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input type="text" id="first-name" name="n_area" class="form-control "></div></div>';
      var ccp      = '<div class="form-group row" id="id_ccp_01"><label class="control-label col-md-3 col-sm-3 " for="first-name">C.c.p/<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="ccp" class="form-control "></div></div>';

      var ccp2      = '<div class="form-group row" id="id_ccp_01"><label class="control-label col-md-3 col-sm-3 " for="first-name">C.c.p/<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="ccp2" class="form-control "></div></div>';
      
      var ccp3      = '<div class="form-group row" id="id_ccp_01"><label class="control-label col-md-3 col-sm-3 " for="first-name">C.c.p/<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="ccp3" class="form-control "></div></div>';

      var ccp4      = '<div class="form-group row" id="id_ccp_01"><label class="control-label col-md-3 col-sm-3 " for="first-name">C.c.p/<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="ccp4" class="form-control "></div></div>';

      var aacr     = '<div class="form-group row" id="id_aacr"><label class="control-label col-md-3 col-sm-3 " for="first-name">LMCA/<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="aacr" class="form-control "></div></div>';

      var PMV     = '<div class="form-group row" id="id_aacr"><label class="control-label col-md-3 col-sm-3 " for="first-name">PMV/<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="aacr" class="form-control "></div></div>';

      var jef_div_est_prof = '<div class="form-group row" id="id_aacr"><label class="control-label col-md-3 col-sm-3 " for="first-name">Jefe (a) de la Div. de Est. Profesionales<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input type="text" id="first-name" name="jef_div_est_prof" class="form-control "></div></div>';

      var fecha = '<div class="form-group row" id="id_aacr"><label class="control-label col-md-3 col-sm-3 " for="first-name">Fecha<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input type="date" id="first-name" name="fecha" class="form-control "></div></div><div class="form-group row" id="id_aacr"><label class="control-label col-md-3 col-sm-3 " for="first-name">Hora inicio<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input type="time" id="first-name" name="hora_inicio" class="form-control "></div></div><div class="form-group row" id="id_aacr"><label class="control-label col-md-3 col-sm-3 " for="first-name">hora fin<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input type="time" id="first-name" name="hora_fin" class="form-control "></div></div>';

    
      var oficio_2 ='<div class="form-group row"><label class="control-label col-md-3 col-sm-3 " for="first-name">Nombre de Jefe de Proyecto de Investigación<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="n_jefe_proy_inv" class="form-control "></div></div><div class="form-group row"><label class="control-label col-md-3 col-sm-3 " for="first-name">Departamento<spanclass="required">*</span></label><div class="col-md-9 col-sm-9 "><input type="text" id="first-name" name="departamento_jefe_proy_inv" class="form-control "></div></div><div class="form-group row"><label class="control-label col-md-3 col-sm-3 " for="first-name">Observaciones<spanclass="required">*</span></label><div class="col-md-9 col-sm-9 "><input type="text" id="first-name" name="observaciones" class="form-control "></div></div>';
      var oficio_3 ='<div class="form-group row" id="id_aacr"><label class="control-label col-md-3 col-sm-3 " for="first-name">Jefe (a) del departamento de Servicios Escolares<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input type="text" id="first-name" name="jef_serv_escolares" class="form-control "></div></div>';
      var oficio_5 ='<div class="form-group row" id="id_aacr"><label class="control-label col-md-3 col-sm-3 " for="first-name">Jefe proyecto Docencia <spanclass="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="jef_proy_doc" class="form-control "></div></div>';
      var oficio_7 = '<div class="form-group row"><label class="control-label col-md-3 col-sm-3 " for="first-name">Dependencia:<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input required type="text" id="first-name" name="dependencia" class="form-control "></div></div><div class="form-group row"><label class="control-label col-md-3 col-sm-3 " for="first-name">Seccion:<span class="required">*</span></label><div class="col-md-9 col-sm-9 "><input type="text" id="first-name" name="seccion" class="form-control required "></div></div>';
        if (id == "9") {
            $("#of1").show();
            $("#of2").html(n_oficio+dirigido+puesto+jef_dep+ccp+aacr);
            $("#of3").hide();
            $("#of4").html(vacio);
            $("#of5").html(vacio);
            $("#of6").html(vacio);
        ...
        if (id == "11") {
          $("#of1").show();
          $("#of2").html(n_oficio+oficio_3+jef_div_est_prof+fecha+ccp+ccp2+ccp3+ccp4+PMV+oficio_7);
          $("#of3").show();
          $("#of4").html(vacio);
          $("#of5").html(vacio);
          $("#of6").html(vacio);
    ...
    function generar_formulario(id) {
      ...
      if (id == "11") {
          ...
          var campos = "";
            ...
            $.ajax({
                url: '{{ route('/coordinacion/oficios/obtener/formulario', '') }}' + '/' + id,
                type: 'get',
                dataType: 'json',
...
<script>
  ...
  $(document).ready(function(){
    $("#mostrar").on( ":checked", function() {
			$('#target').show(); //muestro mediante id
			$('.target').show(); //muestro mediante clase
		 });
		$("#ocultar").on( ":checked", function() {
