...
<body class="nav-md">
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="{{ route('/profesor') }}" class="site_title"><i class="fa fa-graduation-cap"></i>
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-home"></i> Inicio <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ route('/profesor/perfil') }}">Perfil</a></li>
                                        <li><a href="{{ route('profesor/correo/mensajes', 'inbox') }}">Bandeja de entrada</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-edit"></i>Alumnos <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ route('/profesor/alumnos/asignados') }}">Revisor</a></li>
                                        <li><a href="{{ route('/profesor/alumnos/asignados/sinodal') }}">Sinodal</a>
                                        </li>
                                        <li><a href="{{ route('/profesor/alumnos/eventos') }}">Eventos</a></li>
                                        <li><a href="{{ route('/profesor/mensajes') }}">Mensajes</a></li>
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                ...
                                <div class="dropdown-menu dropdown-usermenu pull-right"
                                    ...
                                    <a class="dropdown-item" href="{{ route('/profesor/perfil') }}"><i
                ...
                document.getElementById('logout-form').submit();"><i class="fa fa-sign-out"></i>
                            ...
                            <li role="presentation" class="nav-item dropdown open">
                                <a href="javascript:;" class="dropdown-toggle info-number" id="navbarDropdown1"
                                    ...
                                    <span class="badge bg-red">{{ count($recibidos_ind) }}</span>
                                </a>
                                <!-------------------------------- Muestra mensajes ---------------------------->
                                <ul class="dropdown-menu list-unstyled msg_list "
                                    style="<?php if(count($recibidos_ind)>0){echo "height:180px;";}  else { echo "height:60px;";} ?> overflow:hidden; overflow-y:scroll;" role="menu"
                                    aria-labelledby="navbarDropdown1">
                                    @foreach ($recibidos_ind as $rec)
                                        <li class="nav-item">
                                            <a class="dropdown-item"
                                                href="{{ route('profesor/mensajeSe_Detalle', $rec->id) }}" title="Ver mensaje de: {{ $rec->usuario_envio }}">
                                    ...
                                    <li class="nav-item">
                                        <div class="text-center ">
                                            <a class="dropdown-item"
                                                href="{{ route('profesor/correo/mensajes', 'inbox') }}">
                            ...
                            <li role="presentation" class="nav-item dropdown open" ">
                              <a href=" javascript:;" class="dropdown-toggle info-number" id="navbarDropdown1"
                                data-toggle="dropdown" aria-expanded="false">
                                <i class="fa fa-bell fa-3x" style="color: #34495e; "></i>
                                ...
                                <ul class="dropdown-menu list-unstyled msg_list"
                                    style="<?php if(count($mensajes_rec)>0){echo "height:180px;";}  else { echo "height:60px;";} ?>  overflow:hidden; overflow-y:scroll;" role="menu"
                                    aria-labelledby="navbarDropdown1">
                                    @foreach ($mensajes_rec as $rec)
                                        <li class="nav-item" >
                                            <a class="dropdown-item" href="{{ route('/profesor/mensajes') }}" title="Ver mensaje de: {{ $rec->p_nombre }}">
                                                <span class="image"><img
                                                        src="https://bootdey.com/img/Content/avatar/avatar1.png"
                                                        alt="Profile Image" /></span>
                                                <span>
                                                    <span>
                                                      <small >{{ $rec->p_nombre }}</small>
                                                    </span>
                                                    <span class="time">{{ date_format(new DateTime($rec->fecha), 'd/m/Y H:i:s A') }}
                                                    </span>
                                                </span>
                                                <span class="message">
                                                    {{ str_limit($rec->mensaje, $limit = 100, $end = '...') }}
                                    ...
                                    <li class="nav-item">
                                        <div class="text-center ">
                                            <a class="dropdown-item" href="{{ route('/profesor/mensajes') }}">
                                                <strong>Ver todos los mensajes</strong>
                                                <i class="fa fa-angle-right"></i>
                                            </a>
                                        </div>
    ...
    <script>
        function actualiza(id) {
            ...
            $.ajax({
                url: '{{ route('/profesor/mensajes/actualiza') }}',
                type: 'POST',
                data: {
                    'usuario_envio': id
                },
