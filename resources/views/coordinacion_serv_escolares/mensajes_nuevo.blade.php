                        ...
                        <main>
                            ...
                            <form class="" method="POST" enctype="multipart/form-data"
                                        ...
                                        <select class="form-control" name="usuario" required>
                                            ...
                                            @foreach ($usuarios as $user)
                                                <option class="form-control" value="{{ $user->user_id }}">
                                                    {{ $user->email }}/{{ $user->description }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-10 col-sm-11">
                                        <input type="text" class="form-control" name="asunto" id="bcc" placeholder="Titulo"
                                            required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-11 ml-auto">
                                        ...
                                        <div class="form-group centrar">
                                            ...
                                            <a href="{{ route('/coordinacion/servicios_es/correo/mensajes') }}"
