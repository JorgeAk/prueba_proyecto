                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <img class="img-thumbnail img-circle " width="125" height="125"
                                src="{{ asset('/res/imagen/default.png') }}">

                        </div>

                        <div class="row justify-content-center">

                            <a class="btn btn-sm btn-default fa fa-envelope-square fa-3x"
                                href='mailto:"{{ Auth::user()->email }}"'></a>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="centrar">
                                        ...
                                        <td><a href="#" class="btn btn-success " data-toggle="modal"
                                                data-target="#basicModal2"> <i class="fa fa-wrench"></i> Editar</a>
