...
<div class="right_col" role="main">
    <div>
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i> Coordinacion de Servicios Escolares/Alumnos/<STRONG>Solicitudes</STRONG>
                </li>
            </ol>
        </div>
    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="centrar">
                                        ...
                                        <td style="white-space:nowrap !important;">
                                            ...
                                            @if ($alum->s_estatus == 9)
                                            <a href="{{ route('solicitudDetalleCSE', $alum->id) }}" class="btn btn-lg btn-success btn-sm" title="Dar seguimiento a solicitud" style="display: inline-block !important;"><i class="fa fa-exclamation" aria-hidden="true"></i></a>
                                            @endif
                                                                ...
                                                                <div class="row ">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class=" form-label-group"><label for="inputCarrera">Archivo</label>
                                                                            <a href="{{ route('descargar_archivo', $alum->proy_archivo) }}" download="proyecto_{{ $alum->n_control }}.pdf"><button class="btn btn-success pull-right form-control" style="margin-right: 5px;"><i class="fa fa-cloud-download"></i>&nbsp;&nbsp;<i class="fa fa-file-pdf-o"></i>&nbsp;Descargar
                                                                                    Archivo</button></a>
                                                                        </div>
                                                                        <div class=" form-label-group">
                                                                        ...
                                                                        <div class=" form-label-group">
                                                                            ...
                                                                            <small class="text-danger">*Estatus:
                                                                                {{ $est->nombre }}
                                                                            </small>
                                                                            @endif
                                                                            @endforeach
