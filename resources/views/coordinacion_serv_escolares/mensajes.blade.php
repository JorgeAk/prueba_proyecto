                                ...
                                <div class="details">
                                    ...
                                    @if ($mensj->correo != Auth::user()->email)
                                        ...
                                        <form class="" method="POST" enctype="multipart/form-data"
                                            action="{{ route('/coordinacion/servicios_es/correo/mensajes/nuevo/enviar') }}">
                                            @csrf
                                            <h4 class="centrar"><span> Reponder</span></h4>
                                            <input style="display:none;" type="text" name="usuario"
                                                value="{{ $id_receptor }}" class="form-control" id=""
                                                placeholder="Type email">
                                            <input style="display:none;" type="text" name="asunto" value="Respuesta"
                                                class="form-control" id="" placeholder="Type email">
                                            <!--------------------------------------- text area -------------------------->
                                            ...
                                            <div class="x_content">
                                                ...
                                                <div id="editor-one" class="editor-wrapper placeholderText"
                                                    ...
                                                    oninput="document.querySelector('#description').textContent = this.innerText">
                                                </div>

                                                <textarea name="descr" id="description" id="descripcion"
                                                    style="display:none;">
                                                      </textarea>
