            ...
            <table id="example" class="table table-striped jambo_table ">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td>Disponible</td>
                        <td>
                            <a type="button" class="btn btn-info btn-xs btn-labeled fa fa-location-arrow" data-original-title="Ver mensajes" onclick="actualiza('{{$revisor->id}}')" data-toggle="modal" data-target="#mi_modal{{$revisor->id}}">
                                Ver Mensaje </a>
                        </td>
                    </tr>
                    <?php $total++; ?>
                            ...
                            <div class="panel-heading ">
                                <div class="col-md-12 col-xs-12">
                                    ...
                                    <h4 class="panel-title"><span class="glyphicon glyphicon-comment"></span> Chat -
                                        {{$prof->p_nombre}} {{$prof->s_nombre}} {{$prof->a_paterno}} {{$prof->a_materno}}
                                    </h4>
                                    @endif
                                    @endforeach
                                </div>
