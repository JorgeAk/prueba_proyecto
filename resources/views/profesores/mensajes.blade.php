...
<div class="right_col" role="main">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table id="example" class="table table-striped jambo_table ">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td>Disponible</td>
                        <td>
                            <a type="button" class="btn btn-info btn-xs btn-labeled fa fa-location-arrow" data-original-title="Ver mensajes" data-toggle="modal" onclick="actualiza('{{ $revisor->id }}')" data-target="#mi_modal{{ $revisor->id }}">
                                Ver Mensaje </a>
                        </td>
                    </tr>
                    <?php $total++; ?>
            ...
            @foreach ($revisores as $revisor)
            <!-- Modal -->
            <div class="modal fade" id="mi_modal{{ $revisor->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="chatbody">
                                            <div class="panel panel-primary">
                                                <div class="panel-body msg_container_base">
                                                    ...
                                                    <div class="row msg_container base_sent">
                                                        ...
                                                        <div class="col-md-2 col-xs-2 avatar">
                                                            <img src="{{ asset('/res/imagen/default.png') }}" class=" img-responsive" data-toggle="tooltip" data-original-title="Yo" data-container="body">
                                                        </div>
                                                    </div>
                                                    @else
                                                    ...
                                                    <div class="row msg_container base_receive">
                                                        <div class="col-md-2 col-xs-2 avatar">
                                                            <img src="{{ asset('/res/imagen/default.png') }}" class=" img-responsive ">
                                                        </div>
                                                        <div class="col-md-10 col-xs-10">
                                                ...
                                                <form method="POST" enctype="multipart/form-data" action="{{ route('/profesor/mensajes/nuevo') }}">
                                                    @csrf
