                            ...
                            <table id="example" class="table table-striped jambo_table ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:left; white-space: pre-wrap;"><b>Sala:</b><?php foreach ($salas as $sala) {
                                                                                                            if ($sala->id == $cer->id_sala) {
                                                                                                                echo $sala->nombre;
                                                                                                            }
                                                                                                        } ?><br><b>Fecha:</b> <?php echo date_format(new DateTime($cer->fecha), 'd/m/Y'); ?><br><b>Hora:</b> {{$cer->hora}}</td>
                                        @endif
                                        @endforeach
                                        <td>
                                            ...
                                            <form class="" method="POST" action="{{ route('/profesor/alumnos/asignados/actualizar') }}">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleFormControlTextarea1">
                                                        <h5 class="alert"><i class="fa fa-commenting-o" aria-hidden="true"></i> Si quiere puede agregar algun comentario de lo contrario dejarlo vacio:</h5>
                                                    </label>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="" method="POST" action="{{ route('/profesor/alumnos/asignados/actualizar') }}">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleFormControlTextarea1">
                                                        <h5 class="alert"><i class="fa fa-commenting-o" aria-hidden="true"></i> Agregar algun comentario por el cual no es posible su participacion:</h5>
                                                    </label>
