...
class DocenciaController extends Controller
{
    public function obtener()
    {
        ...
        //dd($recibidos_ind);
        return view('docencia.index', compact('alumno', 'nuevas', 'aceptado', 'revision', 'rechazado', 'recibidos_ind', 'resumen'));
    }
    ...
    public function ceremonias(Request $request)
    {
        ...
        return view('docencia.ceremonias', compact('ceremonias', 'alumnos', 'salas', 'recibidos_ind'));
    }
    ...
    public function obtener_solicitudes()
    {
        ...
        return view('docencia.solicitudes', compact('alumno', 'planes', 'estatus2', 'titulacion', 'estatus', 'profesores', 'revisores', 'sinodales', 'carreras', 'recibidos_ind', 'oficios', 'tipo_oficio', 'documentos'));
    }
    ...
    public function detalle_solicitud($id)
    {
        ...
        */
        ...
        $solicitud = Solicitud::where('id', "$id")->get();
        $recibidos_ind = $this->retorna_mensajes();
        return view('docencia.detalles', compact('solicitud', 'carreras', 'planes', 'op_titulaciones', 'profesores', 'revisores', 'sinodales', 'recibidos_ind', 'oficios', 'documentos', 'tipo_oficio', 'estatus2'));
    }
    ...
    public function obtener_revisores()
    {
        ...
        $recibidos_ind = $this->retorna_mensajes();
        return view('docencia.solicitudes_revisores', compact('alumno', 'revisores', 'profesores', 'estatus', 'recibidos_ind'));
    }
    ...
    public function obtener_sinodales()
    {
        ...
        $estatus    = DB::table('estatus_revisor_sinodal')->get();
        $recibidos_ind = $this->retorna_mensajes();
        return view('docencia.solicitudes_sinodales', compact('alumno', 'sinodales', 'profesores', 'estatus', 'recibidos_ind'));
    }
    ...
    public function obtener_profesores()
    {
        ...
        $profesores = Profesor::all();
        $recibidos_ind = $this->retorna_mensajes();
        return view('docencia.profesores', compact('profesores', 'plan', 'titulacion', 'recibidos_ind'));
    }
    ...
    public function actualizar_profesores(Request $request)
    {
        ...
        if (!empty($_POST) and !empty($usuario)) {
            ...
            $recibidos_ind = $this->retorna_mensajes();
            $resumen = $this->obtener_resumen();
            return view('docencia.index', compact('alumno', 'recibidos_ind', 'resumen'));
        }
    }
    ...
    public function obtener_carreras()
    {
        $carreras = Carrera::all();
        $recibidos_ind = $this->retorna_mensajes();
        return view('docencia.carreras', compact('carreras', 'recibidos_ind'));
    }
    ...
    public function agregar_carrera(Request $request)
    {
        ...
        $alumno = \DB::table('solicitudes')->get();
        $recibidos_ind = $this->retorna_mensajes();
        return view('docencia.index', compact('alumno', 'recibidos_ind'));
    }
    ...
    public function obtener_planes()
    {
        $planes = Plan::all();
        $recibidos_ind = $this->retorna_mensajes();
        return view('docencia.planes', compact('planes', 'recibidos_ind'));
    }
    ...
    public function obtener_mensajes($name)
    {
        if ($name == "inbox") {
            ...
            $recibidos_ind = $this->retorna_mensajes();
            return view('docencia.mensajes_inbox', compact('recibidos', 'enviados', 'm_nuevos', 'paginados', 'fecha', 'recibidos_ind'));
        } else {
            if ($name == "borrados") {
                $usr = auth()->user()->email;
                $estatus = 3;
                ...
                return view('docencia.mensajes_inbox', compact('recibidos', 'enviados', 'm_nuevos', 'paginados', 'recibidos_ind'));
            } else {
                if ($name == "importantes") {
                    $usr = auth()->user()->email;
                    $estatus = 4;
                    ...
                    if ($name == "enviados") {
                        ...
                        return view('docencia.mensajes_inbox_env', compact('recibidos', 'enviados', 'm_nuevos', 'paginados', 'recibidos_ind'));
                    }
                }
            }
        }
    ...
    public function nuevo_mensaje()
    {
        ...
        return view('docencia.mensajes_nuevo', compact('usuarios', 'm_nuevos', 'recibidos_ind'));
    }
    ...
    public function mensajes_detalle($id)
    {
        ...
        //dd($ob_re->correo);
        $recibidos_ind = $this->retorna_mensajes();
        return view('docencia.mensajes', compact('mensaje', 'enviados', 'm_nuevos', 'id_receptor', 'recibidos_ind'));
    }
    ...
    public function obtener_oficios()
    {
        ...
        $recibidos_ind = $this->retorna_mensajes();
        return view('docencia.oficios', compact('oficios', 'recibidos_ind'));
    }
    ...
    public function construir_oficio(Request $request)
    {
        ...
        $pdf = \PDF::loadView('docencia.oficio_imprimir', compact('datos', 'tipo_oficio', 'fecha', 'fecha_completa', 'solicitud', 'carreras', 'planes', 'titulaciones', 'profesores', 'revisores', 'sinodales'));
        $pdf->setPaper('A4');
